export interface GetProjectVersionsPaginated {
     ...
     */
    orderBy?: 'description' | 'name' | 'releaseDate' | 'sequence' | 'startDate' | '+description' | '+name' | '+releaseDate' | '+sequence' | '+startDate' | '-description' | '-name' | '-releaseDate' | '-sequence' | '-startDate' | string;
    /**
