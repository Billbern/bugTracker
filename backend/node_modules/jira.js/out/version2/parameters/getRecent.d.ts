export interface GetRecent {
     ...
     */
    expand?: 'description' | 'projectKeys' | 'lead' | 'issueTypes' | 'url' | 'permissions' | 'insight' | '*' | ('description' | 'projectKeys' | 'lead' | 'issueTypes' | 'url' | 'permissions' | 'insight')[] | string | string[] | GetRecent.Expand | GetRecent.Expand[];
    /**
...
export declare namespace GetRecent {
    enum Expand {
