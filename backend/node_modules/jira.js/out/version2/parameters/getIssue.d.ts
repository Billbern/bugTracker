export interface GetIssue {
     ...
     */
    expand?: 'renderedFields' | 'names' | 'transitions' | 'editmeta' | 'changelog' | 'versionedRepresentations' | ('renderedFields' | 'names' | 'transitions' | 'editmeta' | 'changelog' | 'versionedRepresentations')[] | string | string[] | GetIssue.Expand | GetIssue.Expand[];
    /**
