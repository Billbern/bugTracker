export interface GetWorkflowsPaginated {
     ...
     */
    expand?: 'transitions' | 'transitions.rules' | 'transitions.properties' | 'statuses' | 'statuses.properties' | 'default' | 'schemes' | ('transitions' | 'transitions.rules' | 'transitions.properties' | 'statuses' | 'statuses.properties' | 'default' | 'schemes')[] | string | string[];
