export interface SearchProjects {
     ...
     */
    orderBy?: 'category' | 'issueCount' | 'key' | 'lastIssueUpdatedTime' | 'name' | 'owner' | 'archivedDate' | 'deletedDate' | '+category' | '+issueCount' | '+key' | '+lastIssueUpdatedTime' | '+name' | '+owner' | '+archivedDate' | '+deletedDate' | '-category' | '-issueCount' | '-key' | '-lastIssueUpdatedTime' | '-name' | '-owner' | '-archivedDate' | '-deletedDate' | string;
    /**
