...
export declare class Screens {
     ...
     */
    getScreensForField<T = Models.PageScreenWithTab>(parameters: Parameters.GetScreensForField, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of the
     * screens a field is used in.
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getScreensForField<T = Models.PageScreenWithTab>(parameters: Parameters.GetScreensForField, callback?: never): Promise<T>;
    /**
